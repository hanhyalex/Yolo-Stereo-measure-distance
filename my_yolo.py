...
def yolo_my_img(l_img,r_img):
    ...
    # r_img=r'C:\Users\86198\Desktop\0r.jpg'
...
# ----------rgb算法---------------
    ...
    img_pr = 2 *img_ori[:,:,1]-img_ori[:,:,0]-1.5*img_ori[:,:,2]
...
# -------------------------------
    for box in all_boxes:
        ...
        img_tar2 = img1[box_shape['leftstart'][0]: box_shape['leftstart'][0]+box_shape['hight'],box_shape['leftstart'][1]: box_shape['leftstart'][1]+box_shape['width']]
...
# l_img=r'C:\Users\86198\Desktop\3.jpg'
