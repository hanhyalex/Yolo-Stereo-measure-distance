# -*- coding: utf-8 -*-
"""
Created on Tue Dec 15 19:09:11 2020
...
class MainUi(QtWidgets.QMainWindow):    
  ...
  def init_ui(self):
    ...
    self.left_label_1 = QtWidgets.QPushButton("读入图形")
    self.left_label_1.setObjectName('left_label')
    
    
    self.graphicsView_1 = QtWidgets.QGraphicsView()
    self.graphicsView_1.setGeometry(QtCore.QRect(0, 0, 711, 641))
    
    self.graphicsView_1.setObjectName("graphicsView")
    ...
    self.left_label_1.clicked.connect(self.open_file)
